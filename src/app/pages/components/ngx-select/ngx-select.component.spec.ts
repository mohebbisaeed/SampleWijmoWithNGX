...
describe('NgxSelectComponent', () => {
    ...
    describe('after click', () => {
        ...
        it('single select should focus the roleSearch field', () => {
            fixture.componentInstance.select1.multiple = false;
        });

        it('multiple select should focus the roleSearch field', () => {
            fixture.componentInstance.select1.multiple = true;
        });
    ...
    describe('choice items should be filtered by roleSearch text', () => {
    ...
    describe('test autoClearSearch', () => {
        ...
        it('should not clear roleSearch after select', () => {
            selectItemList(1)[0].click();
            fixture.detectChanges();
            expect(formControlInput(1).value).toBe('br');
        });

        it('should clear roleSearch after select', () => {
